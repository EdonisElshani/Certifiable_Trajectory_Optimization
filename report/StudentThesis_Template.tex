\documentclass[ITR, MA, english, intermediate, tutorial]{LSR_thesis} 
\graphicspath{{pics/}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% English title:
\title{Certifiable Trajectory Optimization for Locomotion via Semidefinite Relaxation}
...
\finalrep{XX.XX.2026} % submission date
